...
export function FooterBook() {
  return (
    <footer className="footer scrollbar-hide flex w-full flex-row flex-wrap items-center justify-center gap-y-6 gap-x-12 border-t border-blue-gray-50 py-6 text-center md:justify-between bg-black text-white my-0 px-5">
